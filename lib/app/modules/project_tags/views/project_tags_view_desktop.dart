...
import 'package:praciar/app/modules/project_tags/controllers/project_tags_controller.dart';
import 'package:praciar/app/widgets/common_button.dart';
import 'package:praciar/app/widgets/common_textfield.dart';

class ProjectTagsViewDesktop extends StatefulWidget {
  ProjectTagsViewDesktop({
    super.key,
    required this.controller,
  });
  ProjectTagsController controller;
  @override
  State<ProjectTagsViewDesktop> createState() => _ProjectTagsViewDesktopState();
}

class _ProjectTagsViewDesktopState extends State<ProjectTagsViewDesktop> {
  @override
